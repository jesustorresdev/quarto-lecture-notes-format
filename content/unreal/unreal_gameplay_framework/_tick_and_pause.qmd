...
Esto afecta a la velocidad a la que reciben *ticks* actores y componente, pero se debe tener en cuenta que no tiene efecto en la simulación del motor de física.
...
Por ejemplo, se pueda crear la ilusión de que un personaje se mueve muy rápido, poniendo el juego globalmente en *slow motion* usando un **Global Time Dilation* de 0.1, pero poniendo el **Custom Time Dilation** del actor del personaje a 10.
