...
Para controlar al **Pawn**, **PathFollowingComponent** necesita que el **Pawn** tenga un componente {{< api NavMovementComponent >}} --como **PawnMovementComponent** o **CharacterMovementComponent**-- ya que espera poder comunicarse con él directamente de la siguiente manera:

* El **NavMovementComponent** tiene las propiedades que representan a un *agente* que se quiere mover usando el sistema de navegación.
