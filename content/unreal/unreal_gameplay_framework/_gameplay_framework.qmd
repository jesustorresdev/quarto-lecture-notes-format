...
* El {{< api WheeledVehiclePawn >}} extiende **Pawn** para implementar la clase base de vehículo con ruedas.
  ...
  Este componente se puede sustituir fácilmente por cualquier componente que herede de {{< api ChaosVehicleMovementComponent >}}, cuando se quiere usar una simulación diferente[Más sobre CDO en @TorresD3DUnrealCpp].
