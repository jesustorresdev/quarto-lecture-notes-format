...
:::{.callout-note}
Existe un componente *legacy* alternativo a **AIPerceptionComponent** que se denomina **PawnSensingComponent** y que se añade al **Pawn** de un NPC, en lugar de al **AIController**.
