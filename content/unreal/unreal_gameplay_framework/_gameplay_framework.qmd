...
%%| file: figures/aicontroller-classes.mm
%%| fig-width: 15cm
```
...
Este subsistema se puede consultar directamente en C++ a través de los métodos de clase {{< api UNavigationSystem >}}[@TorresD3DUnrealCpp], pero también se puede utilizar indirectamente a través de los métodos de **AIController** y el componente **PathFollowingComponent** de este.
...
![Nodo de Blueprint **AI MoveTo** para mover un **Pawn** a un punto o seguir a un actor.](figures/ai-moveto.png){#fig-ai-moveto}
...
Por lo general, la percepción de los NPC --que pueden ver u oír-- se implementa utilizando *raycasts* o *triggers*[@TorresD3DGameplay01].
