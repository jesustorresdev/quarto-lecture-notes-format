...
Por eso Perforce soporta tanto mecanismos para trabajar _offline_ como para usarlo de forma distribuida.
...
Cuando queramos incorporar los cambios al servidor, solo tenemos que abrir el cliente P4V y en el _workspace_ hacer clic con el botón derecho del ratón en la carpeta que contiene los archivos y elegir la opción *Reconcile Offline Work*.
P4V comparará el _workspace_ con el _depot_ y nos mostrará los archivos nuevos y modificados, para que indiquemos qué queremos incorporar<<Perforce-Reconcile>>.
...
. Se debe usar *{p4v-fetch}* periódicamente para traer al servidor personal las actualizaciones realizadas por otros colaboradores en el servidor compartido.
...
* [[[Perforce-Reconcile,10]]]
Perforce Software, Inc. Reconciling offline work. _P4V User Guide_. https://www.perforce.com/manuals/p4v/Content/P4V/using.offline.html

* [[[Perforce-Indie-Studio-Pack,11]]]
