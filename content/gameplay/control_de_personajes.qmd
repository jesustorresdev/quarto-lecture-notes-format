...
Esto significa que se puede rotar el personaje para que mire en una determinada dirección, sin que el controlador tenga que preocuparse por posibles colisiones.
  ...
  Entonces el personaje quedaría atrapado y ya no puede moverse por la escena.
...
Si el personaje se mueve a una velocidad muy alta o el tiempo entre actualizaciones es muy grande, el personaje podría moverse en una trayectoria muy diferente a la esperada.
...
// TODO: Representarlo en una figura
...
En este modo el personaje tienen uu movimiento diferente al del modo «caminar», ya que también puede sumergirse y salir a la superficie.
...
Cuando el control del movimiento es complejo, con múltiples modos diferentes, las máquinas de estados son un buen patrón para su implementación.
...
Por ejemplo, si en el juego tiene mucho peso el combate cuerpo a cuerpo, este tipo de combate suele seguir unas reglas que pueden implementarse fácilmente en su propia máquina de estados.
...
* El control de movimiento actualiza la orientación del personaje para orientarla en la dirección del movimiento del personaje.
  Esta rotación se interpola a lo largo de varios frames, evitando que el personaje cambie de oritentación instantaneamente.
  Como en el caso del movimiento, una rotación más letan se percibe más pesada pero ofrece mayor fidelidad con la animación.
...
Unity proprcional en su paquete *«Starter Assets»*[@UnityStarterAssets] un controlador de personaje más completo y modular --aunque basado en el **CharacterController**-- que incluye los modos de movimiento más comunes en los juegos de acción en primera y tercera persona.
...
Como el **CharacterMovementComponent** no es directamente heredable en Blueprint, este evento sería el lugar para implementar movimientos personalizados directamente en Blueprint.

// TODO: Imagen del nodo
