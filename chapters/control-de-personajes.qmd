...
Como se puede ver en la @fig-movement-substeps, el personaje podría moverse en una trayectoria muy diferente a la esperada se lo hace a una velocidad muy alta o el tiempo entre actualizaciones es muy grande.
...
```{python}
#| label: fig-movement-substeps
#| echo: false
#| fig-cap: "Aproximar una trayectoria en cada *tick* vs. en cada *subpaso*"
import numpy as np
...
y_substeps = initial_height - 0.5 * g * t_substeps**2
...
plt.title("Trayectoria de un proyectil disparado horizontalmente")
