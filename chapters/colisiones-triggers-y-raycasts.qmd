---
abstract: |
  En este capítulo vamos a ver cómo se utilizan as colisiones, los *triggers* y los *raycasts* en los motores de videojuegos.
  Las colisiones definen el espacio de juego y permiten detectar cuándo los objetos se tocan o superponen.
  Los *triggers* se utilizan para sincronizar la acción en el nivel y activar automatismos.
  Los *raycasts* permiten consultar en tiempo real si un objeto está en un lugar determinado.
---
...
# Colisiones, triggers y raycasts {#sec-colisiones-triggers-raycasts}
...
![Vista **Player Collision**.](/assets/colisiones-triggers-y-raycasts/lyra-player-collisions.png){#fig-lyra-player-collisions}

![Vista de render normal.](/assets/colisiones-triggers-y-raycasts/lyra-render.png){#fig-lyra-render}
...
## Mallas de colisión {#sec-collision-meshes}
...
Se utilizan para construir suelos y plataformas por los que se moverá el personaje y para crear los muros que limitarán las zonas accesibles.
...
![Funciones de traslación en Blueprint.](/assets/colisiones-triggers-y-raycasts/translation-functions.png){#fig-translation-functions}
...
![Tanque en *wireframe* con sus colisiones.](/assets/colisiones-triggers-y-raycasts/tank-collision.png){#fig-tank-collisions}
...
![Propiedades de **Collision Presets**.](/assets/colisiones-triggers-y-raycasts/collision-responses.png){#fig-collision-responses}
...
![Perfiles predefinidos de colisión.](/assets/colisiones-triggers-y-raycasts/collision-presets.png){#fig-collision-presets}
...
![Eventos de colisión en Blueprint.](/assets/colisiones-triggers-y-raycasts/event-hit.png){#fig-event-hit}
...
%%| file: ../diagrams/colisiones-triggers-y-raycasts/event-hit-sequence.mmd
```
...
* Para los proyectos más complejos podemos usar los **materiales físicos**.
  En general, estos materiales se asignan a las **colisiones** y sirven para ajustar ciertas propiedades físicas de las superficies, que solo entran en juego si los objetos tienen activada la **simulación física** (ver el @sec-materiales-fisicos).
...
En Unreal Engine los **Physical Material** [@UnrealPhysicalMaterials] son un tipo de *asset* que se puede aplicar a materiales, **Material Instance**, mallas estáticas y **Physics Assets** --que son quienes determinan las colisiones de las mallas esqueletales--.
...
En algunos juegos se usan varios ***triggers*** en una misma arma y en diferentes partes del cuerpo de los personajes, así se pueden aplicar diferentes niveles de daño, según la zona del arma y el área golpeada.
...
Los ***triggers*** son **mallas de colisión** configuradas para no bloquear las colisiones, pero sí para notificar cuando se superponen con otra.
...
Estos actores simplemente tienen un único componente configurado como un ***trigger***:
...
![Eventos de *trigger* en Blueprint.](/assets/colisiones-triggers-y-raycasts/event-overlap.png){#fig-event-overlap}
...
El **Level Blueprint** es un tipo de Blueprint que hace de *manager* global del nivel (ver el @sec-level-blueprint).
...
## Consultas / *raycasts* {#sec-raycasts}
...
![Algunas funciones de *raycast* en Blueprint.](/assets/colisiones-triggers-y-raycasts/line-trace.png){#fig-line-trace}
...
![*Raycasts* de formas en Unreal Engine [@UnrealShapeTraces].](/assets/colisiones-triggers-y-raycasts/shape-traces.png){#fig-shape-traces}
...
## Colisiones simples y complejas {#sec-complex-collision}
...
![*Raycast* a la **colisión compleja** desde el punto de colisión.](/assets/colisiones-triggers-y-raycasts/check-complex-collision.png){#fig-check-complex-collision}
...
A cambio, aumenta el consumo de memoria porque Unreal Engine necesita mantener en la memoria RAM una copia adicional de la posición de los vértices y las coordenadas UV.
...
![Configuración de colisión compleja en **Static Mesh**.](/assets/colisiones-triggers-y-raycasts/complex-collision.png){#fig-complex-collision}
...
* Usar los ***raycasts** de forma inteligente.
  ...
  Por ejemplo, al disparar un arma implementada mediante ***raycasts***, podemos comprobar si el enemigo está lo suficientemente cerca y el arma le están apuntando --por el ángulo respecto a la dirección frontal del personaje-- antes de hacer el ***raycasts**.
...
![Captura de *«Assassin's Creed Odyssey» (2018)*.](/assets/colisiones-triggers-y-raycasts/assassins-creed.jpg){#fig-assassins-creed}
...
%%| file: ../diagrams/colisiones-triggers-y-raycasts/ue-class-hierarchy.mmd
