...
title-meta: "Notas sobre la organización de proyectos"
nocite: |
  @TorresD3DPerforce
---
...
Estás clases generalmente exponen una interfaz pública de métodos, propiedades y eventos accesible desde Blueprint.
...
Aun así, en *«Control de Versiones Con Perforce»* desarrollamos las características y ventajas de Perforce frente a otros VCS.
:::
...
![Panel **Levels** en el editor de Unreal Engine.](figures/ue-sublevels.png){#fig-ue-sublevels}
...
* Cada actor del nivel se guarda en su propio archivo --también conocidos por actores externos-- por lo que al editar no se tiene que bloquear el archivo del nivel sino los de los actores que se están manipulado, lo que facilita la colaboración.
...
![Panel **Data Layers** en el editor de Unreal Engine.](figures/ue-datalayers.png){#fig-ue-datalayers}
