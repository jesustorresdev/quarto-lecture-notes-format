...
Finalmente, el argumento `DamagePreventionChannel` se usa para indicar una canal de colisión en el que la función buscará objetos que puedan bloquear el daño [ver @sec-gameplay].
