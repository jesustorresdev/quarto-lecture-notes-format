---
abstract: 
  En este capítulo se describe la Damage API de Unreal Engine, que facilita la implementación de mecánicas de daño y salud en los juegos.
  Se explican los conceptos fundamentales de la API, como el *daño base*, el *daño efectivo*, los *modificadores de daño*, el *tipo de daño*, el *causante del daño* y el *instigador del daño*, y se detallan los métodos y propiedades de la interfaz de daño de los actores.
---
...
1. Llama al método {{< api InternalTakePointDamage >}}, pasándole los argumentos recibidos.
   Por defecto, este método retorna el *daño base* indicado en `DamageAmount`, pero la idea es que se sobreescriba en las clases hijas de **Actor** para que calcule el *daño efectivo* en base a la información sobre el tipo de daño.
...
![Eventos de daño de los actores en Unreal Engine.](/assets/unreal-damage-api/ontakedamage-events.png){#fig-ontakedamage-events}
...
`TakeDamage()` retorna el *daño efectivo* aplicado, calculado por defecto por los métodos `InternalTakePointDamage()` o `InternalTakeRadialDamage()`.

### Propiedad *CanBeDamaged*

Todo actor tiene una propiedad **Can Be Damaged** para indicar si puede recibir daño o no.
...
![Nodos para aplicar daño a un actor.](/assets/unreal-damage-api/applydamage-methods.png){#fig-applydamage-methods}
...
Finalmente, el argumento `DamagePreventionChannel` se usa para indicar una canal de colisión en el que la función buscará objetos que puedan bloquear el daño (ver la @sec-raycasts).
...
![Nodo SpawnActor de Blueprint.](/assets/unreal-damage-api/spawnactor.png){#fig-spawnactor}
...
![Propiedades del actor **PainCausingVolume**.](/assets/unreal-damage-api/paincausingvolume.png){#fig-paincausingvolume}
...
Se puede desactivar desmarcando la propiedad **Enable World Bounds Checks**.

![Propiedad **Kill Z** en **World Settings**.](/assets/unreal-damage-api/world-killz.png){#fig-world-killz}
