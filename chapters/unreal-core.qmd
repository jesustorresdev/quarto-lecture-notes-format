---
abstract: 
  En este capítulo se describen los componentes fundamentales del motor de Unreal Engine, como **UObject**, **Actor** y **ActorComponent**.
  Se explica cómo arranca un juego y se detalla el papel de cada uno de estos componentes en el proceso.
---
...
Antes de hablar del *gameplay framework* de Unreal Engine en el @sec-unreal-gameplay-framework, vamos a discutir los componentes básicos del motor, sobre los que se implementa dicho *framework*.
...
La clase **UWorld**, por ejemplo, contiene los métodos para instanciar objetos en el nivel y para consultar la geometría del nivel mediante *raycasts* y barridos de formas (ver la @sec-raycasts).
...
![Configurar la clase **GameInstance** del proyecto.](/assets/unreal-core/setup-gameinstance.png){#fig-gameinstance}
...
Sin embargo, desde Unreal Engine 4.22, se recomienda usar *subsistemas* para implementar funcionalidades globales del juego, que antes se implementaban en **GameInstance** (ver el @sec-unreal-subsystems).
